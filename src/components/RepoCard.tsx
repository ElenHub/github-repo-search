...
const RepoCard: React.FC<{ repo: Repo }> = ({ repo }) => {
  return (
    <div className="repo-card border border-gray-800 p-4 shadow-lg max-w-md mx-auto my-4 bg-gray-900 hover:bg-gray-800 transition duration-300 rounded-xl md:min-w-[370px]">
